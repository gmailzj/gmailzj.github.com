...
define("lib/util/tools", [], function(l, d, p) {
...
define("plugin/picRoll", function(l, d) {
    function p() {
    ...
    var a = l("jquery"), c = l("lib/util/tools");
    a.fn.picRoll = function(b) {
        ...
        for (b = 0; b < e.datas.length; b++) {
            var m = e.datas[b], n = c.genDefID("yoho_picroll");
            g.push(n);
            n = a("<a/>").css({display: "block",
                width: e.width,height: e.height,cursor: "pointer",position: "absolute",left: 0,top: d.height() * b * -1}).attr({id: n,"class": "yoho-picroll-piccontent",href: m.href,target: !0 === e.isOpenNew ? "_blank" : "_self"}).appendTo(d);
